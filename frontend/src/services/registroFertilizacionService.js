 ...
 * Archivo: registroFertilizacionService.js
 * Descripcion: Servicio API para registros de fertilizacion.
...
const BASE_PATH = "/api/registros-fertilizacion";

/**
 * Fetches all fertilization records.
 *
...
/**
 * Fetches a fertilization record by id.
 *
...
export const registroFertilizacionService = { getAll, getById, create, update, delete: remove };
