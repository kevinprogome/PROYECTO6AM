 ...
 * Archivo: estadoCultivoService.js
 * Descripcion: Servicio API para estados de cultivo.
...
const BASE_PATH = "/api/estados-cultivo";

/**
 * Fetches all crop status records.
 *
...
/**
 * Fetches a crop status record by id.
 *
...
export const estadoCultivoService = { getAll, getById, create, update, delete: remove };
